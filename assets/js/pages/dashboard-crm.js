...
class DashboardCRM {
    ...
    static init() {
        ...
        if (ratingChart) {
            ...
            new Chart(ratingChartCtx, {
                ...
                options: {
                    ...
                    tooltips: { mode: 'index' },
                    elements: { line: { tension: 0.2, borderWidth: 2 } },
                    scales: {
                        xAxes: [{
                ...
                options: {
                    ...
                    scales: {
                        xAxes: [{
                            ...
                            gridLines: false,
                            ticks: { display: true, beginAtZero: true, fontSize: 13, padding: 10 }
                        }],
                        yAxes: [{
                            display: true,
                            ...
                            ticks: { max: 80, stepSize: 20, display: true, beginAtZero: true, fontSize: 13, padding: 10 }
                        }]
                    }
                }
            });
        ...
        // ---------- Progress Chart ----------
        const progressChart = document.getElementById('porgress-chart');
        if (progressChart) {
