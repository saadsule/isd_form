<div class="page-container">
    <div class="main-content">
        ...
        <div class="page-header">
            <h2 class="header-title">Fixed Site Dashboard</h2>
        </div>
            ...
            <div class="col-12">
                <form method="get" id="filterForm" class="row g-2 align-items-end">
                    ...
                    <div class="col-md-4 mt-2 m-b-15">
                        ...
                        <a href="<?= base_url('dashboard/fixedsite') ?>" class="btn btn-secondary">Clear Filters</a>
                    </div>
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div id="fixedsiteChart" style="height: 450px;"></div>
                        <?php endif; ?>
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    <?php if($isFilterApplied): ?>
        ...
        if (!graphData || graphData.length === 0) {
            document.getElementById("fixedsiteChart").innerHTML =
        ...
        // Render Highcharts
        Highcharts.chart('fixedsiteChart', {
            chart: { type:'spline' },
            exporting: {
                enabled: true,
                buttons: {
            ...
            title: { text:'Daily Fixed Site Trend' },
            xAxis: { 
                categories: days,
                title:{ text:'Date' }
            },
