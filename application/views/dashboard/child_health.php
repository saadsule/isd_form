    ...
    function loadDashboard(filters){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                const ageGroups = response.gender_age.age_groups;
                const maleData = response.gender_age.series.Male || [];
                const femaleData = response.gender_age.series.Female || [];
                ...
                ageGroups.forEach((age, i) => {
                    series.push({
                        name: age,
                        data: [
                            femaleData[i] || 0,   // Female first
                            maleData[i] || 0      // Male second
                        ],
                ...
                Highcharts.chart('genderAgeChart', {
                    ...
                    plotOptions: {
                        series: {
                            stacking: 'percent',
                            colorByPoint: false,   // ✅ IMPORTANT FIX
                            borderWidth: 0,
                            pointPadding: 0,
                            groupPadding: 0,
